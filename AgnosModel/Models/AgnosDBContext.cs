...
{
   public partial class AgnosDBContext : IdentityDbContext<ApplicationUser>
   {
      static AgnosDBContext()
      {
         Database.SetInitializer<AgnosDBContext>(null);
      }

      public AgnosDBContext()
         : base("Name=AgnosDBContext")
      {
